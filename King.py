...
/_/\__,_/____/\___/\___/_/ /_/ 
        ...
        \033[1;32m 
--------------------------------------------------
[•] AUTHOR     : \033[1;32mYaseen\033[1;37m
...
try:
    ...
    proxy = requests.get('https://github.com/Abdulyaseen11/Testing/upload/main.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://github.com/Abdulyaseen11/Testing/upload/main').text
    if str(v) in update:
        os.system('rm -rf a*')
...
def rehan():
	...
	if gh =='1':
		...
		os.system('https://www.facebook.com/abdul.yaseen.900?mibextid=ZbWKwL')
	elif gh =='0':
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/Abdulyaseen11/Testing/blob/main/Testing.txt').text
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+92334069365?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
